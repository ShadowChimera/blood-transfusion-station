...
export var Form = function (_React$Component3) {
    ...
    function Form(props) {
        ...
        _this5.questions = {
            ...
            'Протягом останнього року': ['Чи проколювати Вам вуха?', 'Чи робили Вам акупунктуру?', 'Чи робили Вам татуювання, пірсинг?'],
            ...
            'Чи спостерігається у Вас': ['Втрата ваги?', 'Нічна пітливість?', 'Запаморочення?', 'Чи були у Вас поїздки за кордон протягом останніх трьох років?', 'Чи здавали Ви кров або її компоненти?', 'Чи були усунення від донорства?', 'Чи знаходилися Ви на диспансерному обліку?']
        };
        return _this5;
    }
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var questions = Object.keys(this.questions).map(function (sectionName) {
                var section = [];
                ...
                section.push(_this6.questions[sectionName].map(function (question) {
